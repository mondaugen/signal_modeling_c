...
/* 
 * RLSPYK - RLS predictor in as implemented by Yu and Ko in "Lossless
 * Compression of Digital Audio Using Cascaded RLS-LMS Prediction," IEEE Trans.
 * Speech Audio Processing, Vol. 11, No. 6, November 2003.
 *
 ...
 *
 * mode is whether the filter is doing analysis or synthesis and can be
 * RLSPYK_SYNTHESIS for synthesis mode or RLSPYK_ANALYSIS for analysis mode.
 *
 */
void rlspyk(
        double *d,
